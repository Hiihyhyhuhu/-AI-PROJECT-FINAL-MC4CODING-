...
with col1:
   st.markdown(f"[![Foo]({images[0]})](https://ai-project-final-mc4coding-hiihyhyhuhu.streamlit.app/GET_TO_KNOW_US)")
   st.markdown(f"[![Foo]({images[1]})](https://ai-project-final-mc4coding-hiihyhyhuhu.streamlit.app/GET_TO_KNOW_YOU)")
with col2:
   st.markdown(f"[![Foo]({images[2]})](https://ai-project-final-mc4coding-hiihyhyhuhu.streamlit.app/FINDING_SOMEONE)")
with st.sidebar:
